...
class TeamsWorker(TFCMigratorBaseWorker):
    ...
    def migrate_all(self):
        ...
        # i want to pull from a json that has a source:target mapping
        mapping = json.load(open("TeamsMapping.json"))
        for team, ids in mapping.items():
            teams_map[ids["source"]] = ids["target"]
